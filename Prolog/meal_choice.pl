...
% Example queries
% ?- guest_menu(carnivorous, 1, none, NumMeals, Meals).
% ?- guest_menu(vegetarian, 0, none, NumMeals, Meals).
% ?- guest_menu(fish, 1, lactose_free, NumMeals, Meals).
% ?- guest_menu(vegetarian, 1, gluten_free, NumMeals, Meals).
